    ...
    statics: {
      ...
      findByDistrict(name: string) {
        return this.aggregate([
          ...
          {
            $match: {
              "regencies.districts.name": { $regex: name, $options: "i" },
            },
          },
          {
            $project: {
      ...
      findByVillage(name: string) {
        return this.aggregate([
          ...
          {
            $match: {
              "regencies.districts.villages.name": { $regex: name, $options: "i" },
            },
          },
          {
            $project: {
